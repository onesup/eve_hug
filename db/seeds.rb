...
a = User.create!(
  email:"m1@evezary.co.kr", 
  password:"aaabbb", 
  name:"김이브", 
  phone:"010-9998-9999", 
  profile_picture:"https://graph.facebook.com/100002475544093/picture?type=square",
  birthday: Time.now) 
b = User.create!(
  email:"m2@evezary.co.kr", 
  password:"aaabbb", 
  name:"김자리", 
  phone:"010-9997-9999", 
  profile_picture:"https://graph.facebook.com/100001577845228/picture?type=square",
  birthday: Time.now) 
c = User.create!(
  email:"m3@evezary.co.kr", 
  password:"aaabbb", 
  name:"박이브", 
  profile_picture:"https://graph.facebook.com/100002475544093/picture?type=square",
  phone:"010-9996-9999", 
...
daily_card.card_image_mobile = open(Rails.root.to_s + "/public/images/" + 'daily_card_mobile.png')
daily_card.save()
